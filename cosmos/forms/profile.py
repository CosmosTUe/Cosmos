...
class ProfileCreateForm(forms.ModelForm):
    ...
    subscribed_newsletter = forms.BooleanField(label="Receive newsletter via email", initial=False, required=True)

    class Meta:
        model = Profile
        fields = ["nationality", "department", "program", "terms_confirmed", "subscribed_newsletter"]
